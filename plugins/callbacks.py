    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("BOT Owner", url="https://t.me/battlelorian"),
                    InlineKeyboardButton("Group", url="https://t.me/+DwFx3p9owBdmM2I9")
                ]
            ]
        )
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/+XZpJfRc0kDkxZmJl")
                ],
                [
